...
Hello everyone! I’m Renaud, and I’m the Technical Director at Mastodon. I’ve also been the technical lead for delivering Mastodon releases for several years now. This post is co-written with our lead product designer, Imani.
...
We recently reworked our [roadmap](https://joinmastodon.org/roadmap), to make it more specific about what we working on in the immediate future (three to six months). The roadmap on our site represents what we’re directly building in the current and next release cycle: we deliberately keep it focused, and want to avoid committing to add functionality when we may not yet be ready to support it.
...
We’ll also be redesigning server discovery to showcase the diversity of communities available. You’ll hear more about this from Hannah, our Community Director.

### A decentralised platform for content creators

Public figures, journalists, and institutions are looking for alternatives to mainstream platforms – and we want Mastodon to be their first choice. We're introducing features designed specifically for creators: a redesigned profile view that better showcases your work, and an enhanced compose experience. For organisations like public institutions, we’re working on a new email notification option that lets people follow their updates even if those people don't have a Mastodon account yet. All of this means creators can reach their audiences wherever they are – whether they're active in the Fediverse or still exploring their options. Our goal is to give audiences and creators a way to connect on their own terms, free from algorithmic manipulation.

### Onward, together

These upcoming changes represent our commitment to building a social web that puts people first. Mastodon won't ever harvest your data or chase engagement metrics. We're focused on creating spaces where authentic connection can flourish. If you have thoughts on software improvements, reach out to us at [feedback@joinmastodon.org](mailto:feedback@joinmastodon.org).

### Support Mastodon

We're a small team building software to power the Fediverse. Unlike ad-driven platforms, we operate entirely on donations – and every contribution counts. Learn more on [our donation page](https://joinmastodon.org/sponsors#donate).
