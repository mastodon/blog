...
We also added a way for apps to display notifications for types they do not have explicit support for: https://github.com/mastodon/mastodon/pull/38832 We encourage app developers to support those fallback attributes so notifications about new features (like Collections) are displayed in their apps once they roll out.

We also implemented a new feature to allow visitors to receive an account’s posts by email. Server administrators need to enable this on their server, then grant the permission to a role, then the account needs to opt into it. https://github.com/mastodon/mastodon/pull/38487 https://github.com/mastodon/mastodon/pull/38741
