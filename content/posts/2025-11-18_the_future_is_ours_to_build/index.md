...
Earlier this year, we announced that Mastodon would be [transitioning its legal and operational structures](https://blog.joinmastodon.org/2025/01/the-people-should-own-the-town-square/) to better reflect our mission.
...
{{< figure
  src="team.jpg"
  alt="A photograph of some of the Mastodon team, with their mascot"
  caption="Hannah, our former team-mate Inga, Felix, and Eugen. Friend-shaped #plushtodon, too!"
  class="ma0 w-75"
>}}

An extended leadership team includes [Eugen Rochko](https://mastodon.social/@gargron), [Andy Piper](https://macaw.social/@andypiper), and [Philip Schröpel](https://mastodon.social/@philipkristians). As Strategy & Product Advisor, Eugen will leverage his deep knowledge about the Fediverse / social media and product expertise to support Mastodon's long-term vision and development. Andy will continue in his role as Head of Communications, and Philip as Chief of Staff.

Our next step is to build more ways for the community to get involved with Mastodon at all levels. Our efforts to define community governance are well underway, and we’re looking forward to getting everyone involved in that soon. With that in mind — are you someone who wants to get involved with Mastodon? We’d love to [hear from you](https://joinmastodon.org/about#contact)!
...
As an update on our current status, Mastodon is continuing to run day-to-day operations through the Mastodon gGmbH entity (the Mastodon gGmbH entity automatically became a for-profit as a result of its charitable status being [stripped away in Germany](https://blog.joinmastodon.org/2024/04/mastodon-forms-new-u.s.-non-profit/#mastodons-non-profit-status-in-germany)). The US-based 501(c)(3) continues to function as a strategic overlay and fundraising hub, and as a short-term solution until the AISBL is ready, the 501(c)(3) will own the trademark and other assets. We intend to transfer those assets as soon as the AISBL is ready. To enable tax-deductible donations for German donors, we partnered with WE AID as our fiscal sponsor.
...
One of our main expenditures from the fundraising initiative has been [hiring across our engineering, product, marketing, and operations](https://blog.joinmastodon.org/2025/05/evolving-the-team/#recent-team-changes). Our larger team is making it possible to move faster on important new features like launching [Quote Posts](https://blog.joinmastodon.org/2025/09/introducing-quote-posts/), co-developing [Mastodon’s Collections (our take on "Starter Packs")](https://blog.joinmastodon.org/2025/10/our-ideas-about-packs/), and thinking big thoughts about Mastodon v5.0 (👀). What’s more, our larger team has made it possible to [launch our commercial service offerings](https://blog.joinmastodon.org/2025/09/service-offerings-from-mastodon/) — an important step to ensuring organisations without the technical and moderation resources to start a Mastodon server can finally do so while contributing to our long-term financial sustainability.
...
We also want to thank the law firm [Paul Hastings](https://www.paulhastings.com/) for their generous support by advising us pro bono.

## What’s Next

So what’s next for our team? A different configuration but the same mission: _Ensure that our online social spaces belong to the people forever, and provide a safe place for public discourse_.

If you believe in that mission too, we’d love your support. Grassroots efforts like Mastodon and the Fediverse require [**creative**](https://github.com/mastodon/.github/blob/main/CONTRIBUTING.md) and [**monetary**](https://joinmastodon.org/sponsors#donate) contributions from their communities to survive. It will take all of us working together to build resilient, governable, open and safe digital spaces.
