...
- name: hero
  src: hero.png
---
The European Commission has [just released](https://ec.europa.eu/commission/presscorner/detail/en/ip_26_1187) a major [strategy on technological sovereignty](https://ec.europa.eu/newsroom/dae/redirection/document/129100), and it's placing open source software squarely in the spotlight. The message is clear: open source is key to true digital independence.
...
We look forward to seeing the positive outcomes of this work, and continuing to be part of [the conversation](https://ec.social-network.europa.eu/directory) as Europe continues to embrace open, fair, and collaborative development.
